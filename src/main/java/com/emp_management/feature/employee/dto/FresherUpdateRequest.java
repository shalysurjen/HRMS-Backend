...
/**
 * PUT request for partial update of fresher personal details.
 *
 * ALL fields are optional — only non-null values are applied.
 * The frontend sends only the fields the employee wants to change.
 *
 ...
 * If a file part is absent the existing stored path is kept.
 */
public class FresherUpdateRequest {
    ...
    // ── Children ──────────────────────────────────────────────────
    /**
     * If present (even as empty list), fully replaces existing children.
     * If null (field absent in JSON), children are left unchanged.
     */
    @Valid
